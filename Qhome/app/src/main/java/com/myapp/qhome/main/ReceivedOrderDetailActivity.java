...
public class ReceivedOrderDetailActivity extends BaseActivity {

    TextView title, orderIDBox, orderDateBox, phoneBox, addressBox, addressLineBox, subTotalBox, shippingBox, totalBox, bonusBox;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_received_order_detail);
        ...
        if(Commons.orderItem.getStatus().equals("delivered")){
            ...
            progressButton.setBackgroundResource(R.drawable.primary_stroke);
