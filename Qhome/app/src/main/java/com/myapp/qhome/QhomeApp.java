...
import com.myapp.qhome.utils.LruBitmapCache;

public class QhomeApp extends Application {
    public static final String TAG = QhomeApp.class.getSimpleName();
    ...
    private static QhomeApp _instance;

    public static QhomeApp getApplication() {
        return _instance;
    }
    ...
    public static synchronized QhomeApp getInstance(){
